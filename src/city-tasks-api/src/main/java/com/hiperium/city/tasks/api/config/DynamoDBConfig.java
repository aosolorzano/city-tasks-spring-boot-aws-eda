...
public class DynamoDBConfig {
    ...
    private static final HiperiumLogger LOGGER = HiperiumLogger.getLogger(DynamoDBConfig.class);
    ...
    public DynamoDbAsyncClient dynamoDbAsyncClient(AwsProperties awsProperties) {
        LOGGER.debug("Endpoint Override: {}", awsProperties.endpointOverride);
        LOGGER.debug("Region: {}", awsProperties.region);
